<template>
    <div class="w-screen h-screen flex">
        <!--Side bar-->
        <div class="w-[200px] h-full bg-gray-200 text-white" v-show="showSide">
            <div class="h-[50px] bg-gray-900 flex justify-start items-center ">
                <div class="px-[16px]">
                    <h3 class="font-bold text-x">Admin dashboard</h3>
                </div>
            </div>
            <div class="h-[calc(110vh-50px)] bg-gray-800 py-[20px]">
                <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px]">
                    <div class="flex flex-col justify-between space-y-[10px]">
                        <router-link to="/home-dash"
                ...
                <div class="w-[calc(100%-30px)] flex">
                    ...
                    <div class="w-[200px]">
                        <div class="flex items-center justify-start space-x-4" @click="toggleDrop">
                            <img class="w-10 h-10 rounded-full border-2 border-gray-50" src="./internet.svg" alt="">
                            <div class="font-semibold dark:text-white text-left">
                                <div>Dev OP</div>
                                <div class="text-xs text-gray-500 dark:text-gray-200">Admin</div>
                            </div>
                        </div>
                        <!-- DropMenu-->
